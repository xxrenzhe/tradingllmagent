...
EXPANDED_HIGH_EDGE_NETMAX_EDGES: tuple[ExpandedHighEdge, ...] = (
    ...
    ExpandedHighEdge("session_extreme_reversion", "long", "ny_1200_1559", 1.5, dow=2, trend_bin=-1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("opening_range_breakout", "short", "ny_0930_1159", 1.5, dow=5, trend_bin=-1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("trend_pullback_reclaim", "long", "ny_0930_1159", 1.5, dow=1, trend_bin=1, volume_bin=1, range_bin=0),
    ...
    ExpandedHighEdge("vwap_pullback_bounce", "long", "ny_0930_1159", 1.5, dow=2, trend_bin=1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("prior_day_breakout", "long", "ny_0930_1159", 1.0, dow=5, trend_bin=1, volume_bin=0, range_bin=0),
    ...
    ExpandedHighEdge("prior_day_breakout", "long", "ny_0930_1159", 1.0, dow=5, trend_bin=1, volume_bin=3, range_bin=0),
    ExpandedHighEdge("prior_day_breakout", "short", "ny_0930_1159", 1.25, dow=2, trend_bin=-1, volume_bin=3, range_bin=0),
    ExpandedHighEdge("opening_range_breakout", "short", "ny_1200_1559", 1.5, dow=4, trend_bin=-1, volume_bin=2, range_bin=0),
    ExpandedHighEdge("prior_day_breakout", "short", "ny_0930_1159", 1.25, dow=2, trend_bin=-1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("vwap_reclaim_continuation", "short", "ny_1200_1559", 1.5, dow=4, trend_bin=-1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("opening_range_breakout", "short", "ny_1200_1559", 1.5, dow=4, trend_bin=-1, volume_bin=1, range_bin=0),
    ...
    ExpandedHighEdge("prior_day_breakout", "short", "ny_0930_1159", 1.0, dow=2, trend_bin=-1, volume_bin=2, range_bin=0),
    ExpandedHighEdge("prior_day_breakout", "long", "ny_1200_1559", 1.5, dow=1, trend_bin=1, volume_bin=1, range_bin=0),
    ExpandedHighEdge("opening_range_breakout", "short", "ny_1200_1559", 1.25, dow=4, trend_bin=-1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("selling_absorption_reversal", "long", "ny_0930_1159", 1.5, dow=1, trend_bin=-1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("opening_range_breakout", "short", "ny_1200_1559", 1.25, dow=4, trend_bin=-1, volume_bin=0, range_bin=0),
    ExpandedHighEdge("prior_day_breakout", "long", "ny_0930_1159", 1.5, dow=1, trend_bin=1, volume_bin=3, range_bin=0),
)
