...
_FEATURE_ROWS = [
    ...
    ("bar_volume", "volume", "bar", "Canonical one-minute bar volume; maps Databento OHLCV volume from tick_count."),
    ("volume_1m", "volume", "bar", "One-minute traded volume."),
    ("volume_ma_5", "volume", "bar", "Five-bar moving average of traded volume."),
    ("volume_ma_20", "volume", "bar", "Twenty-bar moving average of traded volume."),
    ("log_volume", "volume", "bar", "Log transformed volume."),
    ("volume_zscore_tod", "volume", "bar", "Volume z-score normalized by time of day."),
    ("relative_volume_5", "volume", "bar", "Current volume divided by five-bar moving average volume."),
    ("relative_volume_20", "volume", "bar", "Current volume divided by twenty-bar moving average volume."),
    ("relative_volume_5m", "volume", "bar", "Five-minute volume versus recent baseline."),
    ("volume_percentile_session", "volume", "bar", "Current volume percentile versus earlier bars in the same UTC session."),
    ("cumulative_volume_vs_expected", "volume", "bar", "Session volume versus expected volume curve."),
    ("volume_spike_flag", "volume", "bar", "One when current volume is at least double the twenty-bar baseline."),
    ("volume_spike_ratio", "volume", "bar", "Current volume divided by recent average volume."),
    ("multi_timeframe_volume_confirm", "volume", "bar", "One when one-, five-, and fifteen-minute volume all exceed recent baselines."),
    ("volume_price_confirm", "volume", "bar", "Direction of five-minute return when volume spikes confirm price movement."),
    ("volume_absorption_flag", "volume", "bar", "Directional absorption proxy when volume spikes but price body is weak."),
    ("low_volume_filter", "volume", "bar", "One when current volume is less than half the twenty-bar baseline."),
