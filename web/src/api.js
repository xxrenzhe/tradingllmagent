...
export const API_PATHS = {
  ...
  ibkrBracketOrders: "/api/gateways/ibkr/bracket-orders",
  ibkrContracts: "/api/gateways/ibkr/contracts",
  ibkrExecutionLedger: "/api/gateways/ibkr/execution-ledger",
  ibkrFastPathOptimizer: "/api/gateways/ibkr/fast-path-optimizer",
  ibkrHealth: "/api/gateways/ibkr/health",
  ibkrIncidents: "/api/gateways/ibkr/incidents",
  ibkrKillSwitch: "/api/gateways/ibkr/kill-switch",
  ibkrMarketData: "/api/gateways/ibkr/market-data",
  ibkrPaperReport: (id = "current") => `/api/ibkr-paper/reports/${encodeURIComponent(id)}`,
  ibkrReadiness: "/api/gateways/ibkr/readiness",
  ibkrReviews: "/api/gateways/ibkr/reviews",
