        ...
        audit = build_completion_audit(
            {
                ...
                "mbp1_microstructure_2r": {
                    "target": {"reward_r": 2.0, "min_win_rate": 0.70},
                    "coverage": {"second_quote_count": 1000},
                    "selected": {
                        "spec": {"direction": "short"},
                        "train": {"win_rate": 0.37, "trade_count": 351, "gate_passed": False},
                        "test": {"win_rate": 0.30, "trade_count": 477, "gate_passed": False},
                    },
                    "decision": {"passed": False},
                },
                "mbp1_microstructure_2r_reversal": {
                    "target": {"reward_r": 2.0, "min_win_rate": 0.70},
                    "coverage": {"second_quote_count": 1000},
                    "selected": {
                        "spec": {"mode": "reversal", "direction": "short"},
                        "train": {"win_rate": 0.41, "trade_count": 365, "gate_passed": False},
                        "test": {"win_rate": 0.31, "trade_count": 627, "gate_passed": False},
                    },
                    "decision": {"passed": False},
                },
                ...
                "mbp1_microstructure_2r_full": {
                    "target": {"reward_r": 2.0, "min_win_rate": 0.70},
                    "coverage": {"second_quote_count": 1000},
                    "selected": {
                        "spec": {"mode": "continuation", "direction": "short"},
                        "train": {"win_rate": 1.0, "trade_count": 2, "gate_passed": False},
                        "test": {"win_rate": 0.33, "trade_count": 48, "gate_passed": False},
                    },
                    "decision": {"passed": False},
                },
